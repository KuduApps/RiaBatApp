...
namespace RiaBat.Web
{
    ...
    public sealed partial class AuthenticationContext : global::System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
    {
        ...
        public AuthenticationContext() : 
                this(new WebDomainClient<IAuthenticationServiceContract>(new Uri("RiaBat-Web-AuthenticationService.svc", UriKind.Relative)))
        {
        }
    ...
    /// <summary>
    /// The 'ClientEntity' entity class.
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/RiaBat.Web")]
    public sealed partial class ClientEntity : Entity
    {
    ...
    public sealed partial class DomainService1 : DomainContext
    {
        ...
        public DomainService1() : 
                this(new WebDomainClient<IDomainService1Contract>(new Uri("RiaBat-Web-DomainService1.svc", UriKind.Relative)))
        {
        }
        ...
        /// <summary>
        /// Gets the set of <see cref="ClientEntity"/> entity instances that have been loaded into this <see cref="DomainService1"/> instance.
        /// </summary>
        public EntitySet<ClientEntity> ClientEntities
        {
            get
            {
                return base.EntityContainer.GetEntitySet<ClientEntity>();
            }
        }
        
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="ClientEntity"/> entity instances using the 'GetClientEntities' query.
        /// </summary>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="ClientEntity"/> entity instances.</returns>
        public EntityQuery<ClientEntity> GetClientEntitiesQuery()
        {
            this.ValidateMethod("GetClientEntitiesQuery", null);
            return base.CreateQuery<ClientEntity>("GetClientEntities", null, false, true);
        }
        ...
        public interface IDomainService1Contract
        {
            ...
            /// <summary>
            /// Asynchronously invokes the 'GetClientEntities' operation.
            /// </summary>
            /// <param name="callback">Callback to invoke on completion.</param>
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/DomainService1/GetClientEntitiesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/DomainService1/GetClientEntities", ReplyAction="http://tempuri.org/DomainService1/GetClientEntitiesResponse")]
            [WebGet()]
            IAsyncResult BeginGetClientEntities(AsyncCallback callback, object asyncState);
            
            /// <summary>
            /// Completes the asynchronous operation begun by 'BeginGetClientEntities'.
            /// </summary>
            /// <param name="result">The IAsyncResult returned from 'BeginGetClientEntities'.</param>
            /// <returns>The 'QueryResult' returned from the 'GetClientEntities' operation.</returns>
            QueryResult<ClientEntity> EndGetClientEntities(IAsyncResult result);
        ...
        internal sealed class DomainService1EntityContainer : EntityContainer
        {
            ...
            {
                this.CreateEntitySet<ClientEntity>(EntitySetOperations.Add);
            }
        }
    }
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("RiaBat-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
